...
class Yolov5Neck(nn.Module):
    def __init__(self, ch, gd=1.0, gw=1.0):
        super().__init__()
        self.gd = gd
        self.gw = gw
        self.conv_1 = Conv(self.gw_div(ch), self.gw_div(512), 1, 1)
        self.upsample_1 = nn.Upsample(None, 2)
        self.c3_1 = C3(self.gw_div(1024), self.gw_div(512), self.gd_muti(3)) 

        self.conv_2 = Conv(self.gw_div(512), self.gw_div(256), 1, 1)
        self.upsample_2 = nn.Upsample(None, 2)
        self.c3_2 = C3(self.gw_div(512), self.gw_div(256), self.gd_muti(3)) 

        self.conv_3 = Conv(self.gw_div(256), self.gw_div(256), 3, 2)
        self.c3_3 = C3(self.gw_div(512), self.gw_div(512), self.gd_muti(3)) 

        self.conv_4 = Conv(self.gw_div(512), self.gw_div(512), 3, 2)
...
class Yolov5DetectHead(nn.Module):
    def __init__(self, ):
        super().__init__()
