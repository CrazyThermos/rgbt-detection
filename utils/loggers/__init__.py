...
class Loggers:
    ...
    def on_train_batch_end(self, model, ni, img_rgb, img_t, targets, rgb_paths, t_paths, vals):
        ...
        if self.plots:
            if ni < 3:
                ...
                plot_images(img_rgb, targets, rgb_paths, f)
                plot_images(img_t, targets, t_paths, f)
