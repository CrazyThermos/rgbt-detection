...
if __name__ == "__main__":
    ...
    EXPORT_DIRECTORY = './'
    DATASET_DIRECTORY = '/datasets/chenguochao/datasets/205_orin/images/val'
    ONNX_PATH = './yolov5s_nc3_bs32_op13.onnx'
    ...
    with ENABLE_CUDA_KERNEL():
        ...
        if RGBT_MODEL:
            ...
            CustomizedExporter().export(file_path=EXPORT_DIRECTORY, save_name='yolov5s_nc3_bs32_op13', 
