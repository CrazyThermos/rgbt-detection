...
from ppq.api import QuantizationSettingFactory, quantize_onnx_model, quantize_torch_model, export_ppq_graph
...
# ------------------------------------------------------------
dummy_input = torch.zeros(size=INPUT_SHAPE, device=DEVICE, dtype=torch.float)
